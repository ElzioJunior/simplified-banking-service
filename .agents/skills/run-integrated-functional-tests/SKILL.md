...
description: Plan, implement, or execute opt-in functional tests through the real application and consequential external boundaries with explicit safety and authorization controls.
---

# Skill — Run Integrated Functional Tests

## Purpose

Plan, implement, or execute opt-in functional tests that exercise the real
application and consequential external boundaries without weakening
deterministic default quality gates.

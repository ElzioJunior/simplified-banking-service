            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    ...
                                    @ExampleObject(
                                            name = "missingAccountValidation", value = ApiExamples.TRANSFER_MISSING_ACCOUNT),
                                    @ExampleObject(
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    @ExampleObject(
                                            name = "missingIdempotencyKey", value = ApiExamples.MISSING_IDEMPOTENCY_KEY),
                                    @ExampleObject(
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            schema = @Schema(implementation = org.springframework.http.ProblemDetail.class),
                            examples = @ExampleObject(
                                    name = "unknownTransferAccount", value = ApiExamples.TRANSFER_ACCOUNT_NOT_FOUND))),
            @ApiResponse(
                    responseCode = "409",
